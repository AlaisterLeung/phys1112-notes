...
<details>
<summary>Challenging question</summary>
...
$$
\begin{align*}
T = \mu gy &\text{ and } \mu = \frac{m}{L} \\
t = \frac{y}{v}
&= \int_0^L \frac{dy}{v} \\
&= \int_0^L \sqrt{\frac{\mu}{\mu gy}} dy \\
&= \frac{1}{\sqrt{g}} \int_0^L \frac{dy}{\sqrt{y}} \\
&= 2\sqrt{\frac{L}{g}}
\end{align*}
$$
...
$$
\begin{align*}
P(x,t) &= \sqrt{\mu T}\omega^2A^2sin^2(kx-\omega t) \\
